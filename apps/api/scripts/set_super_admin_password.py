...
SUPER_ADMIN_PASSWORD_HASH into infra/.env - never stores the plaintext
...
def main() -> None:
    ...
    lines = _upsert_env_var(lines, "SUPER_ADMIN_PASSWORD_HASH", password_hash)
    ENV_PATH.write_text("\n".join(lines) + "\n")

    print(f"\nWrote SUPER_ADMIN_EMAIL and SUPER_ADMIN_PASSWORD_HASH to {ENV_PATH}.")
