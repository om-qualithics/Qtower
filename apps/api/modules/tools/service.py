...
def create_request(org: Org, user: User, request_type: str, name: str, link: str, use_case: str) -> ToolRequest:
...
def update_approved_tool(
    org: Org, tool_id: str, *, name: str, description: str, access_url: str, allowed_tiers: list[str]
) -> ApprovedTool | None:
    ...
    for, without going through a new request."""
